...
public class testModel {
	...
	public void deleteTestUsers() throws SQLException{
		...
		ps = connessione.prepareStatement(insSTR);
		ps.executeUpdate();
		insSTR = "DELETE FROM `sistemavoto`.`voti` WHERE idElezione = 'testReferendum98212';";
		ps = connessione.prepareStatement(insSTR);
		ps.executeUpdate();
		...
		ps = connessione.prepareStatement(insSTR);
		ps.executeUpdate();
		insSTR = "DELETE FROM `sistemavoto`.`candidati` WHERE idElezione = 'testReferendum98212';";
		ps = connessione.prepareStatement(insSTR);
		ps.executeUpdate();
		...
		ps = connessione.prepareStatement(insSTR);
		ps.executeUpdate();
		insSTR = "DELETE FROM `sistemavoto`.`elezioni` WHERE (`idElezioni` = 'testReferendum98212');";
		ps = connessione.prepareStatement(insSTR);
		ps.executeUpdate();
	...
	public void testVoto() throws SQLException{
		...
		HashMap<String,Float> risultatiR2 = new HashMap<String,Float>();
		risultatiR2.put("quorum non raggiunto", new Float(100));
	...
	//	assertEquals(risultatiP, rP.calcolaRisultati("testPreferenziale9821"));
		...
		assertEquals(risultatiR2, rR.calcolaRisultati("testReferendum98212"));
		}
